...
namespace User.Microservice.ViewComponents
{
    public class MenuViewComponent : ViewComponent
    {
        ...
        public MenuViewComponent(IFunctionRepository functionRepository,
           ApplicationDbContext context)//userrManager<ApplicationUser> userManager,
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            //    var rolemenus = (await _functionRepository.GetListOfMenus(item)).Where(t => !menusTemp.Where(m => m.SubMenuController == t.SubMenuController).Any()).ToList();
